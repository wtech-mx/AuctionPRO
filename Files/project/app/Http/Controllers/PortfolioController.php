...
class PortfolioController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/portfolio')->with('message','Gallery Added Successfully.');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('admin/portfolio')->with('message','Gallery Updated Successfully.');
    }
    ...
    public function titles(Request $request)
    {
        ...
        $Portfolio->update($data);
        return redirect('admin/portfolio')->with('message','Gallery Section Title & Text Updated Successfully.');
    }
    ...
    public function destroy($id)
    {
        ...
        $portfolio->delete();
        return redirect('admin/portfolio')->with('message','Gallery Delete Successfully.');
    }
}
