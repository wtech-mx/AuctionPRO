...
//        $input['anonym_donation'] = 1;
        ...
        if ($request->paypal_payment != 1){
            $input['paypal_payment'] = 0;
        }
        if ($request->stripe_payment != 1){
...
//        }
        ...
        $input['basic_charge'] = $request->basic_charge;
        $input['featured_charge'] = $request->featured_charge;
        $input['withdraw_charge'] = $request->withdraw_charge;
        $input['success_msg'] = $request->success_msg;
