...
class PageSettings extends Model
{
    ...
    protected $fillable = ['contact', 'contact_email', 'about', 'faq', 'welcome_title', 'welcome_image', 'welcome_description', 'welcome_link', 'slider_status', 'split_status', 'welcome_status', 'service_status', 'category_status', 'counter_status', 'latest_status', 'featured_status', 'portfolio_status', 'testimonial_status', 'blog_status', 'partners_status', 'home_reg_status', 'w_b_status', 'c_status', 'a_status', 'f_status'];
