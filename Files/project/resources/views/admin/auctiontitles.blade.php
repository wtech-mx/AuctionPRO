                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="add-product-box">
                                    <div class="add-product-header">
                                        <h2>Auction Section Title &amp; Text</h2>
                                    </div>
                                    <hr/>
                                    ...
                                    <form method="POST" action="titles" class="form-horizontal">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="featured_campaign_secttion_title">Featured Auction Section Title *</label>
                                            <div class="col-sm-7">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="featured_campaign_section_text">Featured Auction Section Text *</label>
                                            <div class="col-sm-7">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="latest_campaign_secttion_title">Latest Auction Section Title *</label>
                                            <div class="col-sm-7">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="latest_campaign_section_text">Latest Auction Section Text *</label>
                                            <div class="col-sm-7">
