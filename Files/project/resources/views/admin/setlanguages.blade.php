                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="add-product-box">
                                    ...
                                    <form method="POST" action="{!! action('SettingsController@language') !!}" class="form-horizontal" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-3" for="website_language59">Auctions * <span>(In Any Language)</span></label>
                                            <div class="col-sm-8">
                                                <input type="text" name="auctions" value="{{$language->auctions}}" id="website_language59" class="form-control" placeholder="Your Language" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-3" for="website_language55">Running Auctions * <span>(In Any Language)</span></label>
                                            <div class="col-sm-8">
                                                <input type="text" name="running_auctions" value="{{$language->running_auctions}}" id="website_language55" class="form-control" placeholder="Your Language" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-3" for="website_language56">Completed Auctions * <span>(In Any Language)</span></label>
                                            <div class="col-sm-8">
                                                <input type="text" name="completed_auctions" value="{{$language->completed_auctions}}" id="website_language56" class="form-control" placeholder="Your Language" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-3" for="website_language57">Conditions * <span>(In Any Language)</span></label>
                                            <div class="col-sm-8">
                                                <input type="text" name="conditions" value="{{$language->conditions}}" id="website_language57" class="form-control" placeholder="Your Language" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-3" for="website_language58">Buy Now * <span>(In Any Language)</span></label>
                                            <div class="col-sm-8">
                                                <input type="text" name="buy_now" value="{{$language->buy_now}}" id="website_language58" class="form-control" placeholder="Your Language" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-3" for="website_language6">Auction Details * <span>(In Any Language)</span></label>
                                            <div class="col-sm-8">
                                                <input type="text" name="campaign_details" value="{{$language->auctions_details}}" id="website_language6" class="form-control" placeholder="Your Language" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-3" for="website_language6d">Highest Bid * <span>(In Any Language)</span></label>
                                            <div class="col-sm-8">
                                                <input type="text" name="highest_bid" value="{{$language->highest_bid}}" id="website_language6d" class="form-control" placeholder="Your Language" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-3" for="website_language8s">Bids
                                                * <span>(In Any Language)</span></label>
                                            <div class="col-sm-8">
                                                <input type="text" name="bids" value="{{$language->bids}}" id="website_language8s" class="form-control" placeholder="Your Language" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
