                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="add-product-box">
                                    ...
                                    <form method="POST" action="payment" class="form-horizontal" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="withdraw_charge">Basic Listing Charge($) *</label>
                                            <div class="col-sm-7">
                                                <input type="text" name="basic_charge" value="{{$setting->basic_charge}}" id="withdraw_charge" class="form-control" placeholder="Basic Listing Charge" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="control-label col-sm-4" for="withdraw_charge">Featured Listing Charge($) *</label>
                                            <div class="col-sm-7">
                                                <input type="text" name="featured_charge" value="{{$setting->featured_charge}}" id="withdraw_charge" class="form-control" placeholder="Featured Listing Charge" required>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="add-product-header">
                                                <h3 style="margin-bottom: 0">Payment Options</h3>
                                            </div>
                                            <hr/>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label col-sm-8" for="enable_paypal">Disable/Enable Paypal Payment *</label>
                                                    <div class="col-sm-3">
                                                        @if($setting->paypal_payment == 1)
                                                            <label class="switch">
                                                                <input type="checkbox" id="enable_paypal" name="paypal_payment" value="1"  checked>
                                                                <span class="slider round"></span>
                                                            </label>
                                                        @else
                                                            <label class="switch">
                                                                <input type="checkbox" id="enable_paypal" name="paypal_payment" value="1" >
                                                                <span class="slider round"></span>
                                                            </label>
                                                        @endif
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label col-sm-8" for="enable_stripe">Disable/Enable Stripe Payment *</label>
                                                    <div class="col-sm-3">
                                                        @if($setting->stripe_payment == 1)
                                                            <label class="switch">
                                                                <input type="checkbox" id="enable_stripe" name="stripe_payment" value="1"  checked>
                                                                <span class="slider round"></span>
                                                            </label>
                                                        @else
                                                            <label class="switch">
                                                                <input type="checkbox" id="enable_stripe" name="stripe_payment" value="1" >
                                                                <span class="slider round"></span>
                                                            </label>
                                                        @endif
                                                    </div>
