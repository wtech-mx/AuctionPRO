                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="website">
                                    ...
                                    <form method="POST" action="settings/title" class="form-horizontal form-label-left" id="website_form">
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-4 col-sm-3 col-xs-12" for="title"> Website Title <span class="required">*</span>
                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-4 col-sm-3 col-xs-12" for="facebook"> Show/Hide Gallery Section <span class="required">*</span>
                                            </label>
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-4 col-sm-3 col-xs-12" for="facebook"> Show/Hide Testimonial Section <span class="required">*</span>
                                            </label>
                                            <div class="col-md-3 col-sm-3 col-xs-9">
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-4 col-sm-3 col-xs-12" for="facebook"> Show/Hide Services Section <span class="required">*</span>
                                            </label>
                                            <div class="col-md-3 col-sm-3 col-xs-9">
                                                @if($setting[0]->testi_status == 1)
                                ...
                                <div class="tab-pane" id="payment">
                                    ...
                                    <form method="POST" action="settings/payment" class="form-horizontal form-label-left" id="website_form">
                                        ...
                                        <div class="item form-group">
                                            <label class="control-label col-md-4 col-sm-4 col-xs-12" for="title"> Basic Listing Charge($) <span class="required">*</span>

                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input class="form-control col-md-7 col-xs-12" name="basic_charge" placeholder="Numeric" required="required" type="text" value="{{$setting[0]->basic_charge}}">
                                            </div>
                                        </div>

                                        <div class="item form-group">
                                            <label class="control-label col-md-4 col-sm-4 col-xs-12" for="title"> Featured Listing Charge($) <span class="required">*</span>

                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input class="form-control col-md-7 col-xs-12" name="featured_charge" placeholder="Numeric" required="required" type="text" value="{{$setting[0]->featured_charge}}">
                                            </div>
                                        </div>

                                        <div class="item form-group">
                                            <label class="control-label col-md-4 col-sm-4 col-xs-12" for="title"> Withdraw Fee(%) <span class="required">*</span>

                                            </label>
                                            <div class="col-md-6 col-sm-6 col-xs-12">
                                                <input class="form-control col-md-7 col-xs-12" name="withdraw_charge" placeholder="Numeric" required="required" type="text" value="{{$setting[0]->withdraw_charge}}">
                                            </div>
                                        </div>
