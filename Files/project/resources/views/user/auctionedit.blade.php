            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="section-padding add-product-1">
                        ...
                        <form method="POST" action="{!! action('UserAuctionController@update',['id'=> $auction->id]) !!}" id="add_form" class="form-horizontal form-label-left"  enctype="multipart/form-data">
                            {{csrf_field()}}
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Buy Now Price *
                                    <span>in USD($)</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Start Bid Amount *
                                    <span>in USD($)</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-3">
                                    <button id="add_ads" type="submit" class="btn btn-default add-newProduct-btn">Update Auction</button>
                                </div>
                            </div>
                        </form>
                                </div>
