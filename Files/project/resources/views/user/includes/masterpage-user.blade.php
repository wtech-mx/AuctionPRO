            ...
            <div class="sidebar-menu-body">
                <nav id="sidebar-menu">
                        ...
                        <li class="active">
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <a href="#homeSubmenu" style="padding-left: 20px;" data-toggle="collapse" aria-expanded="false">{{ Auth::user()->name }}
                                        @if(\App\Auction::where('createdby',Auth::user()->id)->count() > 0)
                    ...
                    <ul class="list-unstyled components">
                        ...
                        <li>
                            <a href="{!! url('user/auction') !!}"><i class="fa fa-fw fa-gavel"></i> Auction</a>
                        </li>
                        <li>
                            <a href="{!! url('user/mybids') !!}"><i class="fa fa-fw fa-check"></i> My Bids</a>
                        </li>
                        <li>
                            <a href="{!! url('user/withdraw') !!}"><i class="fa fa-fw fa-bank"></i> Withdraw</a>
                        </li>
                    </ul>
                </nav>
            </div>
