                    ...
                    <div class="section-padding add-product-1">
                        ...
                        <div id="response" class="col-md-12">
                            ...
                            @endif
                                    ...
                                    <form method="POST" action="{!! action('UserAuctionController@store') !!}" class="form-horizontal"  enctype="multipart/form-data">
                                        {{csrf_field()}}
...
@section('footer')
    <script>
        ...
        bkLib.onDomLoaded(function() {
            new nicEditor().panelInstance('auction_description');
        });
    </script>
@stop