...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 26, 2018 at 05:01 PM
...
(1, 'Genius Admin', 'admin', 'admin@gmail.com', '0111111111', 'Bahamas', '$2y$10$IqHFJevSztLR7RpeINrZCuMfSZi0XDY4Pyxu3Pfh5bMfmz3rCnMtO', 'administrator', '1491825290645x430-film-animasi-larrikins-borong-bintang-bintang-australia-160604k.jpg', '2017-01-24 03:21:40', '2017-06-12 15:41:38', '4RQmhCTjS8mCQkkrcq5E7oetP9QSAY5xFpe9iGSQHGxxAgYNC0FYR4p97e3M', 1),
(2, 'S Zaman', 'genius', 'genius@gmail.com', '000000000', NULL, '$2y$10$DozM30vRGMY9aDIh2EKxROmvuJRtBMimO2ox/rF8uXjMBYBjLvVRe', 'administrator', '11822730_1619598781649385_5506560502405630990_n.jpg', '2017-01-27 22:35:17', '2017-03-06 11:02:08', '', 1);
...
(1, 'banner', 'Banner 3', 'http://geniusocean.com', '728x90', '1502034653add.jpg', '', 0, 1);
...
CREATE TABLE `auctions` (
  ...
  `owner` enum('admin','user') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'admin',
  `category` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `title` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `description` text COLLATE utf8_unicode_ci,
  `feature_image` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `condition` enum('New','Used','Recondition') COLLATE utf8_unicode_ci DEFAULT 'New',
  ...
  `paid_status` enum('yes','no') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'no',
  `created_at` datetime DEFAULT NULL,
  `updated_at` datetime DEFAULT NULL,
  `status` enum('pending','open','closed','reject') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'pending'
...
INSERT INTO `auction_gallery` (`id`, `auctionid`, `image`, `stasus`) VALUES
(1, 1, '391501172216Denim-Jumpsuits-For-Spring-Summer-2016-4.jpg', 1),
(2, 1, '8M1501172216ljfsu9-l.jpg', 1),
(3, 7, 'OC1502032505featured.jpg', 1),
(4, 7, 'G41502032505icon.jpg', 1);
...
(20, 'Fashion', 'fashion', '1519659678Donations-min.jpg', 1),
(21, 'Foods', 'foods', 'future.jpg', 1),
(22, 'Health', 'health', 'future.jpg', 1),
(24, 'Innovation', 'innovation', 'future.jpg', 1),
(25, 'Sport', 'sport', 'future.jpg', 1),
(26, 'Test Name', 'one-time44', '1519583281Donations-min.jpg', 1),
(27, 'Test Name22', 'one-time4422', '1519583332Donations-min.jpg', 1);
...
(1, 'browser', 'Windows 8.1', 22, 0, NULL),
(2, 'browser', 'Windows 10', 191, 0, NULL),
(3, 'referral', 'geniusocean.com', 1, 0, NULL),
(4, 'browser', 'Windows 7', 3, 0, NULL),
(5, 'browser', 'Unknown OS Platform', 18, 0, NULL);
...
INSERT INTO `page_settings` (`id`, `contact`, `contact_email`, `about`, `faq`, `welcome_title`, `welcome_image`, `welcome_description`, `welcome_link`, `slider_status`, `split_status`, `welcome_status`, `service_status`, `category_status`, `counter_status`, `latest_status`, `featured_status`, `portfolio_status`, `testimonial_status`, `blog_status`, `partners_status`, `home_reg_status`, `w_b_status`, `c_status`, `a_status`, `f_status`) VALUES
...
INSERT INTO `section_titles` (`id`, `service_title`, `service_text`, `category_title`, `category_text`, `newcamp_title`, `newcamp_text`, `pricing_title`, `pricing_text`, `portfolio_title`, `portfolio_text`, `blog_title`, `blog_text`, `testimonial_title`, `testimonial_text`) VALUES
...
(3, 'Service Name Here', 'Lorem Ipsum is simply dummy text of the printing and typeseatting industry. Lorem Ipsum has been the industry\'s', 'iN3dIs2.jpg', 1),
...
INSERT INTO `settings` (`id`, `logo`, `favicon`, `title`, `url`, `about`, `address`, `phone`, `fax`, `email`, `footer`, `background`, `currency_sign`, `currency_code`, `paypal_business`, `stripe_key`, `stripe_secret`, `theme_color`, `success_msg`, `basic_charge`, `featured_charge`, `withdraw_charge`, `paypal_payment`, `stripe_payment`, `testi_status`, `css_file`) VALUES
(1, 'logo.png', '209.gif', 'Auction Script', 'Fuckcccccc', 'Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae&nbsp;', '124/6 Street, Country', '00 000 000 000', '00 000 000 000', 'admin@geniusocean.com', 'COPYRIGHT 2017 <a href=\"http://geniusocean.com\">GeniusOcean.com<br></a>', 'smm-min2.jpg', '$', 'USD', 'shaon143-facilitator-1@gmail.com', 'pk_test_bD5Si0msHNV75sd5R71jSJFb', 'sk_test_r7zxASOuYYCiuT3svkUtuh6W', NULL, '<h1 class=\"text-center\" style=\"color: green\">Payment Success.<br> Thank You !!</h1>\r\n                        <h2>You Successfully Bought this item.</h2>', 0, 10, 10, 1, 1, 1, 'genius1.css');
...
CREATE TABLE `site_language` (
  ...
  `auctions` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `running_auctions` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `completed_auctions` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `conditions` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `buy_now` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `auctions_details` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `bids` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `highest_bid` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
(3, 'Slider Title 1', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry Lorem Ipsum is simply dummy text of the printing and typesetting industry', 'JG6pexels-photo-48726.jpeg', 'slide_style_left', 1),
(4, 'Slider Title 2', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry Lorem Ipsum is simply dummy text of the printing and typesetting industry', 'WtvJG6pexels-photo-48726.jpg', 'slide_style_right', 1),
...
INSERT INTO `transactions` (`id`, `transaction`, `userid`, `auctionid`, `amount`, `reason`, `featured`, `method`, `address`, `city`, `zip`, `payment_status`, `txn_id`, `charge_id`, `created_at`, `updated_at`, `status`) VALUES
(1, '2a1501340725', 2, 3, 10, 'listing', 'no', 'Stripe', NULL, NULL, NULL, 'Completed', 'txn_1AkwVULYzRkN5IL2ThmhoUjC', 'ch_1AkwVULYzRkN5IL22jfekthy', '2017-07-29 15:05:32', '2017-07-29 15:05:32', 'completed'),
(2, 'Fu1501603599', 2, 1, 900, 'buy', 'no', 'Stripe', NULL, NULL, NULL, 'Completed', 'txn_1Am2tNLYzRkN5IL2Ckw7z6jw', 'ch_1Am2tNLYzRkN5IL2KojLavWI', '2017-08-01 16:06:43', '2017-08-01 16:06:43', 'completed'),
(3, 'y41501603892', 2, 1, 900, 'buy', 'no', 'Stripe', NULL, NULL, NULL, 'Completed', 'txn_1Am2y8LYzRkN5IL2sdkRv0YB', 'ch_1Am2y8LYzRkN5IL2mG6J5I2v', '2017-08-01 16:11:38', '2017-08-01 16:11:38', 'completed'),
(4, 'C21501678512', 4, 4, 10, 'listing', 'yes', 'Stripe', NULL, NULL, NULL, 'Completed', 'txn_1AmMNhLYzRkN5IL2SuqYnzDt', 'ch_1AmMNhLYzRkN5IL2Li5dO7Ke', '2017-08-02 12:55:19', '2017-08-02 12:55:19', 'completed'),
(5, 'Xt1501694452', 4, 4, 700, 'buy', 'no', 'Stripe', NULL, NULL, NULL, 'Completed', 'txn_1AmQWoLYzRkN5IL2Y1RVZZ9m', 'ch_1AmQWnLYzRkN5IL2rfZEU1HO', '2017-08-02 17:20:58', '2017-08-02 17:20:58', 'completed'),
(7, 'v11501843442', 2, 6, 10, 'listing', 'yes', 'Paypal', NULL, NULL, NULL, 'Completed', '4KD700086U496953K', NULL, '2017-08-04 10:44:02', '2017-08-04 10:44:38', 'completed'),
(17, '5o1501929772', 2, 5, 1300, 'buy', 'no', 'Paypal', NULL, NULL, NULL, 'Pending', NULL, NULL, '2017-08-05 10:42:52', '2017-08-05 10:42:52', 'pending'),
(18, 'Ap1501929970', 2, 5, 1300, 'buy', 'no', 'Paypal', 'Test Address', 'Dhaka', '1234', 'Completed', '57Y85319L2542591D', NULL, '2017-08-05 10:46:10', '2017-08-05 10:46:56', 'completed'),
(20, 'wg1501937043', 4, 6, 600, 'buy', 'no', 'Paypal', 'Washington DC', 'NYC', '2314', 'Completed', '5EH05171CK155591X', NULL, '2017-08-05 12:44:03', '2017-08-05 12:44:35', 'completed');
...
INSERT INTO `user_profiles` (`id`, `name`, `gender`, `phone`, `fax`, `email`, `password`, `country`, `address`, `city`, `zip`, `acc_balance`, `created_at`, `updated_at`, `remember_token`, `status`) VALUES
(2, 'User Name', NULL, '22222', '324344', 'user@gmail.com', '$2y$10$PdI5luZqAmZyZWZxbjyvlu4R1s.wqMvjthk7we.lEK2X6VlVgWY3.', 'Afghanistan', 'sss', 'ssss', 'ssss', 1260, '2017-05-04 11:59:39', '2017-08-05 12:45:36', 'LUW3pzNOZh06ClQf5PL8XQXcTCMFtR4yLb806VjNhyGNY93as2RSNzc5t2Tf', 1),
(4, 'Shaon Zaman', NULL, '555555555', NULL, 'shaoneel@gmail.com', '$2y$10$vN5VgKAS0Rtk0FSsKOQ0eerawMSbMIeMg.e86mZl0yf8NwqbUCLda', NULL, NULL, NULL, NULL, 0, '2017-07-30 12:21:12', '2017-07-30 12:21:12', NULL, 1),
(5, 'Badruddoza Chowdhury', NULL, '1723565773', NULL, 'badruddoza.me@gmail.com', '$2y$10$GLRyCGfSahoEoIPraiQFzOmMqeGHt0c8JMpsdT5WbwBB0aKeICGby', NULL, NULL, NULL, NULL, 0, '2018-02-25 13:05:58', '2018-02-25 13:05:58', NULL, 1);
...
--
-- Indexes for table `auction_gallery`
--
ALTER TABLE `auction_gallery`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `auction_gallery`
--
ALTER TABLE `auction_gallery`
